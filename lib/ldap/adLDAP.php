...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@hospital.com";
    /**
    ...
    * @var string
    */
	protected $baseDn = "DC=hospital,DC=com"; 
    ...
    * @var array
    */
    protected $domainControllers = array("hospital.com");
    ...
    */
    public function connect() 
    {
        ...
        if ($this->useSSL) {
            $this->ldapConnection = ldap_connect("172.28.24.40");
