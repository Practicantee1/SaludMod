          ...
          <div class="card shadow p-1 mb-1"> 
            <div class="card-header" style="background-color: transparent !important;"> 
              <!-- <div class="row"  id="MainTittle-UbiCitas">
                <div class="col-20 text-center top: -10px;">
                  <h2 class="text-success " style="margin-top: 10px;"  >Control de acceso</h2>
                </div>  
              </div>  -->
                        ...
                        <table id="TablaIncapacidades" class="table table-striped table-hover">
                          <thead class="thea" style="background-color:rgb(29, 151, 78);">
                            <tr class="text-center">
                              ...
                              <th class="text-center justify-content-center align-middle bg-success" scope="col">N° Identificación <br> Paciente</th>
                              <th class="text-center justify-content-center align-middle bg-success" scope="col">Tipo Documento <br> Acompañante</th>
                              <th class="text-center justify-content-center align-middle bg-success" scope="col">Identificación <br> Acompañante</th>
                  ...
                  <div class="modal-content rounded-4 shadow-lg">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="mb-3">
                        ...
                        <select id="Genero" name="Genero" class="form-select border-success">
                          <option value="#" >Seleccione una opción</option>
                      ...
                      <input type="hidden" class="form-control border-success" id="Bed_code" name="Bed_code" readonly>
                    </div>
...
$(document).ready(function() {
    $("#btn-Documento, #btn-Nombre, #limpiarCampos").on("click", function(e) {
        e.preventDefault();

        limpiarCamposPaciente();

        $("#consulta-nombres").hide();
        $("#modal-tabla").hide();
        $("#consulta-Documento").hide();

        if (this.id === "btn-Documento") {
            $("#consulta-Documento").show();
        }

        if (this.id === "btn-Nombre") {
            $("#consulta-nombres").show();
        }

        // Restablecer botón de acompañantes a su estado inicial
               
        $("#Search-acompanante").html('<i class="fa-solid fa-user-group"></i>&nbsp;&nbsp;Acompañantes');  // Texto inicial
        $("#motivoDeshabilitado").hide();                          // Ocultar mensaje, por si acaso
    });
    ...
    // Si se borra manualmente el IDNumber, también limpiamos y reiniciamos
    $("#IDNumber").on("input", function() {
        if ($(this).val().trim() === "") {
            limpiarCamposPaciente();

            // Estado inicial del botón al borrar el documento
           // $("#Search-acompanante").prop("disabled", true);
            $("#Search-acompanante").html('<i class="fa-solid fa-user-group"></i>&nbsp;&nbsp;Acompañantes');
            $("#motivoDeshabilitado").hide();
        }
    });
});
