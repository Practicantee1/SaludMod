...
if (!isset($_SESSION["nombre"])) {
    $_SESSION["PrePage"] = "../Modulos/Implantes/View/inhabilitar_casa.php";
                ...
                <div class="col-md-15">
                    <div class="card shadow p-3 mb-8">
                        <div class="card-header">
                            ...
                            <h4 class="form-label text-divider-r"><span class="left-span"></span><span class="span">Inhabilitar de Casas comerciales</span></h4>
                            ...
                            <div class="row" style="margin-bottom: 20px">
                                ...
                                <div class="col-md-8">
                                <label>Inhabilitar Casa Comercial</label>
                                    <select class="form-control" name="infCasaComercial" id="bloqueo_casa" required>
                                        <option id='placeholder' selected disabled hidden value="">Seleccione la Casa Comercial</option>
                                        <?php
                                        $consultarsala = "SELECT id_casa_comer, nombre_casaComer FROM tbl_casa_comercial WHERE estado = '1' ORDER BY id_casa_comer";
                                ...
                                <div class="col-md-4" style="text-align: center;">
                                    <br>
                                    <button type="button" class="btn btn-primary" id="inhabilitarbtn">
