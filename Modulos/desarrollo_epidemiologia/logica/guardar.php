...
// file_put_contents('php://stderr', "Valor de idProfesional: $idProfesional\n", FILE_APPEND);
...
try {
    ...
    $stmt->bind_param("sssssssss", $episodio, $tipo_documento, $documento, $nombre, $edad, $genero, $ubicacion, $cama, $entidad);
    $stmt->execute();
