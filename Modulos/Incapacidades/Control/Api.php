<script>  
    ...
    if(isset($answer)){
        ...
        //$Nombre = explode(", ",$DoctorData["NombreUsuario"]);
        //$DatosIncapacidad["NombreMedico"] = $Nombre[1].' '.$Nombre[0];
        ...
        $DatosIncapacidad['Registro'] =  $DoctorData["NMédicoSS"];

        $Doc = $DoctorData["Episodio"];
    } 
    else{
