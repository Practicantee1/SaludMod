        ...
        success: function(response) {
            if (Array.isArray(response)) {
                if (response.length > 0) {
                    ...
                    var tableBody = $('.table-entrada tbody'); // Selecciona específicamente la tabla de entrada
                    ...
                    response.forEach(function(item) {
                        ...
                        var row = '<tr>' +
                            ...
                            '<td class="text-center">' + (item.nombre_completoE || '') + '</td>' +
                            '<td class="text-center">' + (item.numero_documentoE || '') + '</td>' +
                            '</tr>';
